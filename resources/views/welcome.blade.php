...
<div class="relative flex items-top justify-center min-h-screen sm:items-center sm:pt-0">
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Matrix_multiplication_qtl1.svg/620px-Matrix_multiplication_qtl1.svg.png">
        </div>

        <h3>How to use API</h3>

        <pre>
            <code>POST api/matrix-multiplication
{
    "matrixA":[
        [1,2,3],
        [1,2,3]
    ...
    "matrixB":[
        ...
        <i>The resulting matrix is containing characters rather than numbers - similar to excel columns. <br>
            Examples: 1 => A, 26 => Z, 27 => AA, 28 => AB.</i>
        <pre>
            <code>
[
    ["F", "L", "R"],
